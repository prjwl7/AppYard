    ...
    <>
        <div className="chooseContainer">
            <div className="questionmark">
                ...
                <div className="questionMarkImage"><img src={questionMark} alt="" className='questionMarkImage2' /></div>
            </div>
            <div className="timeAndWallet">
                <div className="time">
                    ...
                    <div style={{fontSize:24, fontWeight:600}} className='timeContent2'>Time Management</div>
                ...
                <div className="tool">
                    ...
                    <div style={{fontSize:24, fontWeight:600}} className='toolContent2'>Ease of maintenance</div>
                    <div style={{fontSize:16, fontWeight:400}} className='toolContent3'>Makes your life easier. We Provide Seamless Maintenance for your Apps</div>
                    </div>
                </div>
                <div className="walletDiv">
                    <img src={wallet} alt="" />
                    <div className="walletContent" style={{marginLeft:120, width:'50%', display:'flex', flexDirection:'column', gap:30}}>
                    <div style={{fontSize:24, fontWeight:600}}className='walletDivContent2'>Cost effective</div>
                    <div className='walletDivContent3' >We deliver you the most optimal product both aesthetically and economically</div>
                    </div>
                </div>
            </div>
        </div>
